	...
	<div id='page-wrap'>
		<?php 
			...
			if(!isset($_SESSION['email'])){
				echo '<script language="javascript">alert("Ups! Inicia sesión para ver este contenido!");</script>';
				header('Location: Login.php');
			} 
			if (!($_SESSION['rol']=="profe")) {
	            echo '<script language="javascript">alert("Ups! Esta página es sólo para PROFESORES!");</script>';
