	...
	<div id='page-wrap'>
		...
		<section class="main" id="s1">
			...
			<?php 
				...
				function GuardarPregunta($complejidad, $tema, $email, $enunc, $r_c, $r_i1, $r_i2, $r_i3){
				...
				if(isset($_POST['enunciado'])){
					if(valoresCompletos()){
						...
						if(!GuardarPregunta($complejidad, $tema, $email, $enuc, $r_c, $r_i1, $r_i2, $r_i3))
							$error = 'No se ha podido guardar el comentario en la base de datos.';
