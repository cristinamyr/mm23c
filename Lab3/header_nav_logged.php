...
<nav class='main' id='n1' role='navigation'>
	...
	<span><a href='pregunta.php?email=<?php echo $email;?>&path=<?php echo $path;?>'>Preguntas</a></spam>
	<span><a href='VerPreguntas.php?email=<?php echo $email;?>&path=<?php echo $path;?>'>Ver Preguntas</a></spam>
	<span><a href='VerPreguntasXML.php?email=<?php echo $email;?>&path=<?php echo $path;?>'>Ver Preguntas XML</a></spam>
