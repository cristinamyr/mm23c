...
<body>
	<div id='page-wrap'>
		<?php 		        
	        if(!isset($_SESSION['rol'])){  echo '<script language="javascript">alert("No deberías haber llegado hasta aqui");';
	            echo "window.location = 'layout.php'";
				echo '</script>';}
	        else{
	        	if($_SESSION['rol'] != "estudiante") {
	            	echo '<script language="javascript">alert("No deberías haber llegado hasta aqui");';
	            echo "window.location = 'layout.php'";
				echo '</script>';
	        	}
	        }
