<?php 
		...
		if (isset($_SESSION['rol'])) {
	            echo '<script language="javascript">alert("Ya estás logeado, no intentes volvernos loco!");';
        ...
        if (!isset($_POST['passw'])){
             echo '<script language="javascript">alert("No deberías haber llegado hasta aquí");';
	            echo "window.location = 'layout.php'";
				echo '</script>';
        }
		$passw = $_POST['passw'];
